...
export const locationEn: LocationItem[] = [
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "Seattle-Tacoma International Airport: The Pacific Northwest's gateway. Viaro provides professional car service to all Puget Sound destinations.",
      },
    ...
    trustBar: ["Flight Tracking", "Save 12% Early", "Pro Chauffeurs", "24/7 Booking"],
    bodyContent: {
      ...
      image: {
        ...
        caption: "SEA-TAC's Central Terminal handles over 51 million passengers yearly, making fast ground transportation essential.",
      },
      content: [
  ...
  image: {
    ...
    alt: "Aerial view of Seattle I-5 traffic congestion near downtown with alternate routes highlighted.",
    caption: "SEA-TAC's North Satellite expansion added 12 new gates — your Viaro driver is already tracking your flight.",
  },
  content: [
    ...
    <>
      The airport recently completed a major expansion at the North Satellite, adding 12 new gates. The{" "}
      <A href="https://www.portseattle.org/sea-tac/airlines-destinations">SEA Airport official website</A>{" "}
      has real-time flight status and terminal maps.{" "}
    </>,
  ...
  items: [
    { label: "Downtown Seattle",  time: "20 min", desc: "Pike Place Market, Amazon HQ, convention center, waterfront hotels" },
    { label: "Bellevue",          time: "25 min", desc: "Microsoft campus, T-Mobile HQ, Bellevue Square, tech corridor" },
    { label: "Redmond",           time: "35 min", desc: "Microsoft main campus, Nintendo of America, tech offices" },
    { label: "Tacoma",            time: "30 min", desc: "Port of Tacoma, downtown Tacoma, Joint Base Lewis-McChord" },
    { label: "Cruise Terminals",  time: "25 min", desc: "Pier 66, Pier 91 (Smith Cove) for Alaska cruise departures" },
  ],
},{
        h3: "Local Destinations from SEA-TAC",
        image: {
          src: "/images/SeaTacLocal.png",
          alt: "Popular Viaro destinations from SeaTac: downtown Seattle skyline, Bellevue business district, and Seattle cruise terminal.",
caption: "From tech campuses in Bellevue to cruise ships at Pier 91, Viaro connects you to all of Puget Sound.",
        },
        content: [
          <>
            Heading to{" "}
            <A href="https://www.edgewaterhotel.com">The Edgewater Hotel</A>{" "}
            on the waterfront? Or the{" "}
            <A href="https://www.fairmont.com/seattle">Fairmont Olympic Hotel</A>{" "}
            downtown? We know the fastest routes and drop-off points at every major Seattle hotel.
          </>,
          <>
            For business travelers visiting{" "}
            <A href="https://www.amazon.jobs/en/locations/seattle">Amazon's South Lake Union Campus</A>,{" "}
            the{" "}
            <A href="https://www.wscc.com">Seattle Convention Center</A>,{" "}
            or tech offices in the Eastside corridor, our chauffeurs provide a quiet mobile office with charging so you can prepare for meetings en route.
          </>,
        ],
        ...
        image: {
          ...
          alt: "Aerial view of Seattle I-5 traffic congestion near downtown with alternate routes highlighted.",
caption: "Our drivers know every alternate route — saving you 20–30 minutes on busy days.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://wsdot.wa.gov/travel/real-time/traffic">WSDOT</A>{" "}
            and adjust routes during your trip. If the 520 bridge backs up, we take I-90. If there is an accident near{" "}
            <A href="https://www.seahawks.com">Lumen Field (home of the Seattle Seahawks)</A>,{" "}
            we know before you hit the merge. This local knowledge saves 20–30 minutes on busy days.
          </>,
        ],
      ...
      
      {
        ...
        image: {
          ...
          alt: "Viaro black SUV dropping off passengers at Pier 91 Smith Cove cruise terminal in Seattle.",
          caption: "Direct transfers from SEA-TAC to Pier 66 and Pier 91 — your driver handles all luggage.",
        },
        content: [
          ...
          <>
            Check your cruise line's terminal at the{" "}
            <A href="https://www.portseattle.org/cruise">Port of Seattle cruise page</A>.{" "}
            We track your incoming flight, so even if you land late, we will get you to the ship on time.
          </>,
        ],
    ...
    pricing: {
      ...
      vehicles: [
        { type: "Sedan",        price: 129, passengers: 3, bags: 2, extras: ["Professional chauffeur", "Flight tracking included", "Purple elevator pickup"] },
        { type: "SUV",          price: 159, passengers: 6, bags: 5, extras: ["Extra luggage space", "Pre-assigned chauffeur", "Flight tracking included"], badge: "Most Popular" },
        { type: "Meet & Greet", price: 25,  passengers: 0, bags: 0, extras: ["Driver inside terminal", "Name sign at baggage claim", "Add-on to any vehicle"] },
      ],
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "From Wall Street to Teterboro, JFK to Newark—Viaro delivers seamless executive transportation across the New York metro area.",
      },
    ...
    trustBar: ["60,000+ Trips", "99.8% On-Time", "5 Airports", "24/7 Live Support"],
    ...
    bodyContent: {
      ...
      image: {
        ...
        caption: "We know every terminal, every traffic pattern, and every shortcut across New York and New Jersey.",
      },
      content: [
    ...
    extraContent: [
  {
    ...
    image: {
      ...
      caption: "JFK's terminals spread across 5 miles of roads — your Viaro chauffeur meets you curbside, no confusion.",
    },
    content: [
      ...
      <>
        ...
        <A href="https://www.discoverlongisland.com/the-hamptons/">The Hamptons</A>.
      </>,
    ],
  },
  {
    ...
    image: {
      ...
      alt: "Viaro chauffeur meeting passengers at LaGuardia Airport Terminal B commercial vehicle lane.",
      caption: "LaGuardia's new Terminal B — beautiful airport, confusing rideshare pickup. Viaro meets you at the commercial vehicle lane.",
    },
    content: [
  ...
  },
  {
    ...
    image: {
      ...
      caption: "Newark Terminal C — United's hub. Viaro tracks your terminal and waits at the right curb.",
    },
    content: [
      ...
      <>
        Popular destinations from EWR: Jersey City, Hoboken, Lower Manhattan (via Holland Tunnel),{" "}
        <A href="https://www.prucenter.com/">Prudential Center</A>, Princeton, and Philadelphia connections.
      </>,
    ],
  },
  {
    ...
    image: {
      ...
      caption: "Teterboro — where Wall Street flies. We meet you at the jet stairs. Total time on the ground: under 2 minutes.",
    },
    content: [
      ...
      <>
        ...
        Where security allows, we meet you at the jet stairs. Total time on the ground: under 2 minutes.
      </>,
  ...
  },
  {
    ...
    image: {
      ...
      caption: "Westchester County Airport — skip JFK chaos. Straight shot to Manhattan via I-95 or Hutchinson River Parkway.",
    },
    content: [
      ...
      <>
        Insider tip: If you live in Westchester, Greenwich, or Stamford—skip the chaos of JFK and LaGuardia. HPN is your home airport. Viaro provides transfers to{" "}
        <A href="https://www.ibm.com/">IBM headquarters</A>,{" "}
        <A href="https://www.pepsico.com/">PepsiCo</A>, and the hedge fund corridor in Stamford.
      </>,
    ],
    ...
    whereSection: {
      ...
      image: {
        ...
        caption: "From five-star hotels to Fortune 500 headquarters, Viaro moves New York's most demanding travelers.",
      },
      content: [
        <>
          Manhattan Hotels:{" "}
          <A href="https://www.theplazany.com/">The Plaza</A>,{" "}
          <A href="https://www.marriott.com/hotels/travel/nycxr-the-st-regis-new-york/">The St. Regis</A>,{" "}
        ...
        <>
          ...
          <A href="https://www.broadway.com/">Broadway theaters</A>, Yankee Stadium, MetLife Stadium.
        </>,
        ...
        <>See our full{" "}
        <A href={`/en/black-car-service/corporate-transportation`}>corporate transportation services</A>{" "}
        and{" "}
        <A href={`/en/black-car-service/hourly-chauffeur-hire`}>hourly chauffeur options</A>
        </>
      ],
    ...
    pricing: {
      ...
      vehicles: [
        { type: "Sedan",        price: 95,  passengers: 3,  bags: 2,  extras: ["Professional chauffeur", "Flight tracking included", "Flat rate — no surge"] },
        { type: "SUV",          price: 135, passengers: 6,  bags: 5,  extras: ["Extra luggage space", "Pre-assigned chauffeur", "Flight tracking included"], badge: "Most Popular" },
        { type: "Sprinter Van", price: 299, passengers: 13, bags: 10, extras: ["Group & corporate travel", "Forward-facing captain's chairs", "USB charging"] },
      ],
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "From Hollywood to the beaches, LAX to Van Nuys—Viaro delivers seamless executive transportation across Greater Los Angeles.",
      },
    ...
    trustBar: ["60,000+ Trips", "99.8% On-Time", "6 Airports", "24/7 Live Support"],
    ...
    bodyContent: {
      ...
      image: {
        ...
        caption: "We know every terminal, every back road, and every traffic pattern across Greater Los Angeles.",
      },
      content: [
    ...
    extraContent: [
  {
    ...
    image: {
      ...
      caption: "LAX arrivals — skip the rideshare chaos. Viaro meets you curbside at the correct terminal, every time.",
    },
    content: [
      ...
      <>
        ...
        <A href="https://www.santamonica.com/">Santa Monica</A>, Downtown LA,{" "}
        <A href="https://www.hollywoodchamber.net/">Hollywood</A>, Malibu, and Westside tech offices.
      </>,
    ],
  },
  {
    ...
    image: {
      ...
      caption: "Van Nuys — the world's busiest general aviation airport. We meet you at the jet stairs.",
    },
    content: [
      ...
      <>
        ...
        <A href="https://www.signatureflight.com/">Signature Flight Support</A>,{" "}
        <A href="https://www.castlecookeaviation.com/">Castle & Cooke Aviation</A>, and{" "}
        <A href="https://www.jetaviation.com/">Jet Aviation</A>.{" "}
        Where security allows, we meet you at the jet stairs. Step off the plane and into the back seat.
      </>,
  ...
  },
  {
    ...
    image: {
      ...
      caption: "Burbank — walk straight out the gate to your Viaro car. No shuttles, no remote lots.",
    },
    content: [
      ...
      <>
        ...
        <A href="https://www.universalstudioshollywood.com/">Universal Studios</A>, Disney Studios, Pasadena/Rose Bowl, Glendale.
      </>,
    ],
  },
  {
    ...
    image: {
      ...
      caption: "Long Beach — boutique airport, zero LAX traffic. Closest to the Port of Long Beach cruise terminal.",
    },
    content: [
      ...
      <>
        ...
        <A href="https://www.queenmary.com/">Queen Mary</A>, Aquarium of the Pacific, Downtown Long Beach, Orange County beaches, Disneyland.
      </>,
    ],
  },
  {
    ...
    image: {
      ...
      caption: "John Wayne Airport — 15 minutes to Disneyland, 10 minutes to Newport Beach. Calmer than LAX.",
    },
    content: [
      <>
        John Wayne Airport (also known as SNA or JWA) serves Orange County's affluent beach communities—{" "}
        <A href="https://www.visitnewportbeach.com/">Newport Beach</A>,{" "}
        <A href="https://www.visitlagunabeach.com/">Laguna Beach</A>, Irvine, and the{" "}
        <A href="https://disneyland.disney.go.com/">Disneyland Resort</A>.{" "}
        For travelers heading south of LA, this airport saves 30–60 minutes compared to LAX.
      </>,
      ...
      <>
        ...
        <A href="https://www.visitnewportbeach.com/">Newport Beach</A>,{" "}
        <A href="https://www.visitlagunabeach.com/">Laguna Beach</A>, Irvine tech campuses, Anaheim Convention Center.
      </>,
    ],
    cta: "Book Your Airport Transfer →",
  },
    ...
    whereSection: {
      ...
      image: {
        ...
        caption: "From studio lots to beachfront hotels, Viaro moves LA's most demanding travelers.",
      },
      content: [
        <>
          Luxury Hotels:{" "}
          <A href="https://www.fourseasons.com/beverlywilshire/">Beverly Wilshire</A>,{" "}
          <A href="https://www.peninsula.com/en/beverly-hills">The Peninsula Beverly Hills</A>,{" "}
          <A href="https://www.chateaumarmont.com/">Chateau Marmont</A>, Hotel Bel-Air, Shutters on the Beach.
        </>,
        ...
        <>
          ...
          <A href="https://www.cryptoarena.com/">Crypto.com Arena</A>, Dodger Stadium, Rose Bowl,{" "}
          <A href="https://www.lacclink.com/">LA Convention Center</A>.
        </>,
        <>
          Shopping &amp; Lifestyle:{" "}
          <A href="https://www.rodeodrive-bh.com/">Rodeo Drive</A>, The Grove, Century City, South Coast Plaza, Fashion Island.
        </>,
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "From the Magnificent Mile to O'Hare, the Loop to the suburbs—Viaro delivers seamless executive transportation across Chicagoland.",
      },
    ...
    trustBar: ["60,000+ Trips", "99.8% On-Time", "3 Airports", "Locked Rates — No Surges", "24/7 Live Support"],
    ...
    bodyContent: {
      ...
      image: {
        ...
        caption: "We know every terminal, every traffic pattern, and every weather workaround across Chicagoland.",
      },
      content: [
    ...
    extraContent: [
  {
    ...
    image: {
      ...
      caption: "O'Hare Terminal 5 — international arrivals can take 90 minutes through customs. Viaro is already tracking your landing.",
    },
    content: [
      ...
      <>
        ...
        <A href="https://www.mccormickplace.com/">McCormick Place</A>, River North, Evanston, and the western suburbs.
      </>,
    ],
  },
  {
    ...
    image: {
      ...
      caption: "Midway — closer to downtown than O'Hare, faster security. Viaro meets you at the commercial vehicle lane.",
    },
    content: [
  ...
  },
  {
    ...
    image: {
      ...
      caption: "DuPage FBO — Chicagoland's premier private aviation gateway. Total time on ground: seconds, not minutes.",
    },
    content: [
      ...
      <>
        ...
        and{" "}
        <A href="https://www.atlanticaviation.com/">Atlantic Aviation</A>.{" "}
        Where security allows, we meet you at the jet stairs. You step off the plane and into the back seat—total time on the ground measured in seconds, not minutes.
      </>,
    ...
    whereSection: {
      ...
      image: {
        ...
        caption: "From the Magnificent Mile to corporate campuses, Viaro moves Chicago's most demanding travelers.",
      },
      content: [
        <>
          Luxury Hotels:{" "}
          <A href="https://www.peninsula.com/en/chicago">The Peninsula Chicago</A>,{" "}
          <A href="https://www.langhamhotels.com/en/the-langham/chicago/">The Langham</A>,{" "}
          <A href="https://www.fourseasons.com/chicago/">Four Seasons</A>,{" "}
          <A href="https://www.ritzcarlton.com/en/hotels/chicago">The Ritz-Carlton</A>, Waldorf Astoria, Park Hyatt.
        </>,
        <>
          Business Districts: The Loop, River North, West Loop, Fulton Market, Merchandise Mart, Willis Tower,{" "}
          <A href="https://www.boeing.com/">Boeing Global HQ</A>, and suburban campuses in Schaumburg, Oak Brook, and Naperville.
        </>,
        <>
          Conventions &amp; Events:{" "}
          <A href="https://www.mccormickplace.com/">McCormick Place</A>{" "}
          (largest convention center in North America), Navy Pier,{" "}
          <A href="https://www.unitedcenter.com/">United Center</A>, Soldier Field, Wrigley Field.
        </>,
        <>
          Shopping &amp; Culture:{" "}
          <A href="https://www.themagnificentmile.com/">Magnificent Mile</A>, Oak Street,{" "}
          <A href="https://www.artic.edu/">Art Institute of Chicago</A>, Millennium Park, Chicago Theatre district.
        </>,
        <>
          Universities &amp; Medical:{" "}
          <A href="https://www.northwestern.edu/">Northwestern University</A>, University of Chicago, Rush Medical Center, Northwestern Memorial Hospital.
        </>,
       <>See our full{" "}
        <A href={`/en/black-car-service/corporate-transportation`}>corporate transportation services</A>{" "}
        and{" "}
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "From SFO to Napa Valley, Silicon Valley to the city—Viaro delivers seamless executive transportation across the Bay Area.",
      },
    ...
    trustBar: ["60,000+ Trips", "99.8% On-Time", "3 Airports", "24/7 Live Support"],
    ...
    bodyContent: {
      ...
      image: {
        ...
        caption: "We know every terminal, every freeway merge, and every rush-hour workaround across the Bay Area.",
      },
      content: [
...
extraContent: [
  {
    ...
    image: {
      ...
      caption: "SFO International Terminal — Viaro tracks your flight through fog delays and meets you at the upper level pickup zone.",
    },
    content: [
      ...
      <>
        ...
        <A href="https://www.sftravel.com/">Downtown San Francisco</A>, Silicon Valley (Palo Alto, Mountain View, Menlo Park),{" "}
        <A href="https://www.visitnapavalley.com/">Napa Valley</A>, and Peninsula corporate campuses.
      </>,
    ],
  },
  {
    ...
    image: {
      ...
      caption: "San Jose Airport — 10 minutes to Google, 15 minutes to Apple Park. The smart choice for Silicon Valley.",
    },
    content: [
      ...
      <>
        ...
        <A href="https://about.meta.com/">Meta</A>, Stanford University, Santa Cruz, and Monterey.
      </>,
    ],
  },
  {
    ...
    image: {
      ...
      caption: "Oakland Airport — no fog, faster security, and Viaro knows when to take the San Mateo Bridge instead of the Bay Bridge.",
    },
    content: [
      ...
      <>
        ...
        <A href="https://www.berkeley.edu/">UC Berkeley</A>, Downtown Oakland, Walnut Creek, Pleasanton/Dublin tech parks, and connections to San Francisco via Bay Bridge.
      </>,
    ],
    cta: "Book Your Airport Transfer →",
  },
    ...
    whereSection: {
      ...
      image: {
        ...
        caption: "From Salesforce Tower to Sonoma vineyards, Viaro moves the Bay Area's most discerning travelers.",
      },
      content: [
        <>
          Wine Country:{" "}
          <A href="https://www.visitnapavalley.com/">Napa Valley</A>,{" "}
          <A href="https://www.sonomacounty.com/">Sonoma</A>, Healdsburg, Yountville, St. Helena. Our hourly chauffeur service is perfect for full-day wine tours.
        </>,
        <>
          Luxury Hotels:{" "}
          <A href="https://www.fairmont.com/san-francisco/">Fairmont San Francisco</A>,{" "}
          <A href="https://www.marriott.com/hotels/travel/sfoxr-the-st-regis-san-francisco/">The St. Regis</A>,{" "}
          <A href="https://www.fourseasons.com/sanfrancisco/">Four Seasons</A>, Ritz-Carlton, Palace Hotel.
        </>,
        <>
          Tech Campuses: Apple Park (Cupertino), Googleplex (Mountain View), Meta HQ (Menlo Park),{" "}
          <A href="https://www.salesforce.com/">Salesforce Tower</A>{" "}
          (SF), Netflix (Los Gatos), Adobe, NVIDIA, LinkedIn, and Sand Hill Road VC offices.
        </>,
        <>
          Conventions &amp; Events:{" "}
          <A href="https://www.moscone.com/">Moscone Center</A>{" "}
          (Dreamforce, Apple WWDC, Google I/O),{" "}
          <A href="https://www.chasecenter.com/">Chase Center</A>, Oracle Park, Levi's Stadium.
        </>,
        <>
          Universities:{" "}
          <A href="https://www.stanford.edu/">Stanford University</A>, UC Berkeley, UCSF, Santa Clara University.
        </>,
      <>See our full{" "}
        <A href={`/en/black-car-service/corporate-transportation`}>corporate transportation services</A>{" "}
        for executive roadshows and investor meetings.
         </>      ],
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "Aeropuerto Internacional Seattle-Tacoma: La puerta de entrada al Pacífico Noroeste. Viaro ofrece servicio profesional de auto a todos los destinos de Puget Sound.",
      },
      ...
      cta: { book: "Reserva el Servicio de Auto en SEA-TAC", phone: "(206) 672-8281" },
    },

    trustBarTitle: "La confianza de los viajeros de Puget Sound",
    trustBar: ["Rastreo de Vuelos", "Ahorra 12% Reservando Antes", "Choferes Profesionales", "Reservas 24/7"],
    bodyContent: {
      ...
      image: {
        ...
        caption: "La Terminal Central del SEA-TAC atiende a más de 51 millones de pasajeros al año, haciendo esencial un transporte terrestre rápido.",
      },
      content: [
    ...
    extraContent: [
      {
        ...
        image: {
          ...
          caption: "La expansión del Satélite Norte del SEA-TAC añadió 12 nuevas puertas — tu conductor Viaro ya está rastreando tu vuelo.",
        },
        content: [
          ...
          <>
            El aeropuerto completó recientemente una gran expansión en el Satélite Norte, añadiendo 12 nuevas puertas. El{" "}
            <A href="https://www.portseattle.org/es/sea-tac/airlines-destinations">sitio web oficial del Aeropuerto SEA</A>{" "}
        ...
        items: [
          { label: "Centro de Seattle",    time: "20 min", desc: "Pike Place Market, sede de Amazon, centro de convenciones, hoteles frente al mar" },
          { label: "Bellevue",             time: "25 min", desc: "Campus de Microsoft, sede de T-Mobile, Bellevue Square, corredor tecnológico" },
          { label: "Redmond",              time: "35 min", desc: "Campus principal de Microsoft, Nintendo of America, oficinas tech" },
          { label: "Tacoma",               time: "30 min", desc: "Puerto de Tacoma, centro de Tacoma, Base Conjunta Lewis-McChord" },
          { label: "Terminales de Crucero", time: "25 min", desc: "Pier 66, Pier 91 (Smith Cove) para salidas de cruceros a Alaska" },
        ],
      },
      {
        ...
        image: {
          ...
          caption: "Desde los campus tecnológicos de Bellevue hasta los cruceros en el Pier 91, Viaro te conecta con todo Puget Sound.",
        },
        content: [
          <>
            ¿Te diriges al{" "}
            <A href="https://www.edgewaterhotel.com">Hotel Edgewater</A>{" "}
            frente al mar? ¿O al{" "}
            <A href="https://www.fairmont.com/seattle">Fairmont Olympic Hotel</A>{" "}
            en el centro? Conocemos las rutas más rápidas y los puntos de llegada en cada hotel importante de Seattle.
          </>,
          <>
            Para viajeros de negocios que visitan el{" "}
            <A href="https://www.amazon.jobs/es/locations/seattle">Campus South Lake Union de Amazon</A>,{" "}
            el{" "}
            <A href="https://www.wscc.com">Centro de Convenciones de Seattle</A>,{" "}
            o las oficinas tech en el corredor del Eastside, nuestros choferes ofrecen una oficina móvil tranquila con carga para que puedas prepararte para tus reuniones en el camino.
          </>,
        ],
      },
      {
        ...
        image: {
          src: "/images/SeattleTraffic.png",
          alt: "Vista aérea del tráfico en la I-5 de Seattle cerca del centro con rutas alternativas destacadas.",
          caption: "Nuestros conductores conocen cada ruta alternativa — ahorrándote entre 20 y 30 minutos en días de mucho tráfico.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://wsdot.wa.gov/travel/real-time/traffic">WSDOT</A>{" "}
            y ajustamos las rutas durante tu viaje. Si el puente 520 se congestiona, tomamos la I-90. Si hay un accidente cerca del{" "}
            <A href="https://www.seahawks.com">Lumen Field (estadio de los Seattle Seahawks)</A>,{" "}
            lo sabemos antes de que llegues al empalme. Este conocimiento local te ahorra entre 20 y 30 minutos en días concurridos.
          </>,
        ],
      },
      {
        ...
        image: {
          ...
          caption: "Traslados directos desde el SEA-TAC al Pier 66 y Pier 91 — tu conductor maneja todo el equipaje.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://www.portseattle.org/es/cruise">página de cruceros del Puerto de Seattle</A>.{" "}
            Rastreamos tu vuelo entrante, así que aunque aterrices tarde, te llevaremos al barco a tiempo.
          </>,
        ],
    ...
    pricing: {
      ...
      vehicles: [
        { type: "Sedán",        price: 129, passengers: 3, bags: 2, extras: ["Chofer profesional", "Rastreo de vuelo incluido", "Recogida en elevador morado"] },
        { type: "SUV",          price: 159, passengers: 6, bags: 5, extras: ["Espacio extra para equipaje", "Chofer asignado previamente", "Rastreo de vuelo incluido"], badge: "Más Popular" },
        { type: "Meet & Greet", price: 25,  passengers: 0, bags: 0, extras: ["Conductor dentro de la terminal", "Letrero con tu nombre en el reclamo de equipaje", "Complemento para cualquier vehículo"] },
      ],
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "Desde Wall Street hasta Teterboro, de JFK a Newark—Viaro ofrece transporte ejecutivo impecable en toda el área metropolitana de Nueva York.",
      },
    ...
    trustBar: ["60,000+ Viajes", "99.8% a Tiempo", "5 Aeropuertos", "Soporte en Vivo 24/7"],
    ...
    bodyContent: {
      ...
      image: {
        ...
        caption: "Conocemos cada terminal, cada patrón de tráfico y cada atajo en Nueva York y Nueva Jersey.",
      },
      content: [
    ...
    extraContent: [
      {
        ...
        image: {
          ...
          caption: "Las terminales del JFK se extienden por 5 millas de carreteras — tu chofer Viaro te recibe en la acera, sin confusión.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://www.discoverlongisland.com/the-hamptons/">Los Hamptons</A>.
          </>,
        ],
      },
      {
        ...
        image: {
          src: "/images/LGATerminal.png",
          alt: "Chofer Viaro recibiendo pasajeros en el carril de vehículos comerciales de la Terminal B del Aeropuerto LaGuardia.",
          caption: "La nueva Terminal B de LaGuardia — aeropuerto hermoso, recogida de rideshare confusa. Viaro te recibe en el carril de vehículos comerciales.",
        },
        content: [
      ...
      },
      {
        ...
        image: {
          ...
          caption: "Terminal C de Newark — el hub de United. Viaro rastrea tu terminal y espera en la acera correcta.",
        },
        content: [
          ...
          <>
            Destinos populares desde EWR: Jersey City, Hoboken, Bajo Manhattan (vía Túnel Holland),{" "}
            <A href="https://www.prucenter.com/">Prudential Center</A>, Princeton y conexiones a Filadelfia.
          </>,
        ],
      },
      {
        ...
        image: {
          ...
          caption: "Teterboro — donde vuela Wall Street. Te recibimos al pie de la escalerilla. Tiempo total en tierra: menos de 2 minutos.",
        },
        content: [
          ...
          <>
            Consejo interno: Viaro coordina directamente con las operaciones FBO en{" "}
            <A href="https://www.signatureflight.com/">Signature Flight Support</A>{" "}
            y{" "}
            <A href="https://www.atlanticaviation.com/">Atlantic Aviation</A>.{" "}
            Donde la seguridad lo permite, te recibimos al pie de la escalerilla. Tiempo total en tierra: menos de 2 minutos.
          </>,
      ...
      },
      {
        ...
        image: {
          ...
          caption: "Aeropuerto del Condado de Westchester — evita el caos del JFK. Directo a Manhattan por la I-95 o la Hutchinson River Parkway.",
        },
        content: [
          ...
          <>
            Consejo interno: Si vives en Westchester, Greenwich o Stamford—evita el caos del JFK y LaGuardia. HPN es tu aeropuerto local. Viaro ofrece traslados a la{" "}
            <A href="https://www.ibm.com/">sede de IBM</A>,{" "}
            <A href="https://www.pepsico.com/">PepsiCo</A> y el corredor de fondos de cobertura en Stamford.
          </>,
        ],
    ...
    whereSection: {
      ...
      image: {
        ...
        caption: "Desde hoteles cinco estrellas hasta sedes de Fortune 500, Viaro mueve a los viajeros más exigentes de Nueva York.",
      },
      content: [
        <>
        ...
        <>
          ...
          <A href="https://www.msg.com/">Madison Square Garden</A>,{" "}
          <A href="https://www.lincolncenter.org/">Lincoln Center</A>,{" "}
          <A href="https://www.broadway.com/">Teatros de Broadway</A>, Yankee Stadium, MetLife Stadium.
        </>,
        ...
        <>Consulta nuestros{" "}
          <A href={`/es/black-car-service/corporate-transportation`}>servicios completos de transporte corporativo</A>{" "}
          y{" "}
          <A href={`/es/black-car-service/hourly-chauffeur-hire`}>opciones de chofer por hora</A>
        </>
      ],
    ...
    pricing: {
      ...
      vehicles: [
        { type: "Sedán",        price: 95,  passengers: 3,  bags: 2,  extras: ["Chofer profesional", "Rastreo de vuelo incluido", "Tarifa fija — sin incrementos"] },
        { type: "SUV",          price: 135, passengers: 6,  bags: 5,  extras: ["Espacio extra para equipaje", "Chofer asignado previamente", "Rastreo de vuelo incluido"], badge: "Más Popular" },
        { type: "Van Sprinter", price: 299, passengers: 13, bags: 10, extras: ["Viajes grupales y corporativos", "Asientos capitán orientados al frente", "Carga USB"] },
      ],
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "Desde Hollywood hasta las playas, de LAX a Van Nuys—Viaro ofrece transporte ejecutivo impecable en todo el Gran Los Ángeles.",
      },
    ...
    trustBar: ["60,000+ Viajes", "99.8% a Tiempo", "6 Aeropuertos", "Soporte en Vivo 24/7"],
    ...
    bodyContent: {
      ...
      image: {
        ...
        caption: "Conocemos cada terminal, cada camino secundario y cada patrón de tráfico en todo el Gran Los Ángeles.",
      },
      content: [
    ...
    extraContent: [
      {
        ...
        image: {
          ...
          caption: "Llegadas en LAX — evita el caos del rideshare. Viaro te recibe en la acera de la terminal correcta, siempre.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://www.hollywoodchamber.net/">Hollywood</A>, Malibú y oficinas tech del Westside.
          </>,
        ],
      },
      {
        ...
        image: {
          ...
          caption: "Van Nuys — el aeropuerto de aviación general más concurrido del mundo. Te recibimos al pie de la escalerilla.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://www.signatureflight.com/">Signature Flight Support</A>,{" "}
            <A href="https://www.castlecookeaviation.com/">Castle & Cooke Aviation</A> y{" "}
            <A href="https://www.jetaviation.com/">Jet Aviation</A>.{" "}
            Donde la seguridad lo permite, te recibimos al pie de la escalerilla. Bajas del avión y entras al asiento trasero.
          </>,
      ...
      },
      {
        ...
        image: {
          ...
          caption: "Burbank — sal directo de la puerta a tu auto Viaro. Sin shuttles, sin estacionamientos lejanos.",
        },
        content: [
      ...
      },
      {
        ...
        image: {
          ...
          caption: "Long Beach — aeropuerto boutique, sin tráfico del LAX. El más cercano a la terminal de cruceros del Puerto de Long Beach.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://www.queenmary.com/">Queen Mary</A>, Acuario del Pacífico, centro de Long Beach, playas de Orange County, Disneyland.
          </>,
        ],
      },
      {
        ...
        image: {
          ...
          caption: "Aeropuerto John Wayne — 15 minutos a Disneyland, 10 minutos a Newport Beach. Más tranquilo que el LAX.",
        },
        content: [
          <>
            El Aeropuerto John Wayne (también conocido como SNA o JWA) atiende a las prósperas comunidades de playa de Orange County—{" "}
            <A href="https://www.visitnewportbeach.com/">Newport Beach</A>,{" "}
            <A href="https://www.visitlagunabeach.com/">Laguna Beach</A>, Irvine y el{" "}
            <A href="https://disneyland.disney.go.com/">Resort de Disneyland</A>.{" "}
            Para viajeros que se dirigen al sur de LA, este aeropuerto ahorra entre 30 y 60 minutos comparado con el LAX.
          </>,
          ...
          <>
            ...
            <A href="https://disneyland.disney.go.com/">Disneyland</A>,{" "}
            <A href="https://www.visitnewportbeach.com/">Newport Beach</A>,{" "}
            <A href="https://www.visitlagunabeach.com/">Laguna Beach</A>, campus tech de Irvine, Centro de Convenciones de Anaheim.
          </>,
        ],
        cta: "Reserva Tu Traslado al Aeropuerto →",
      },
    ...
    whereSection: {
      ...
      image: {
        ...
        caption: "Desde los sets de filmación hasta los hoteles frente al mar, Viaro mueve a los viajeros más exigentes de LA.",
      },
      content: [
        <>
          Hoteles de lujo:{" "}
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "Desde la Magnificent Mile hasta O'Hare, desde el Loop hasta los suburbios—Viaro ofrece transporte ejecutivo impecable en todo Chicagoland.",
      },
      ...
      cta: { book: "Reserva Tu Auto Negro en Chicago", phone: "(206) 672-8281" },
    },

    trustBarTitle: "La confianza de los ejecutivos y negociadores de Chicago",
    trustBar: ["60,000+ Viajes", "99.8% a Tiempo", "3 Aeropuertos", "Tarifas Fijas — Sin Incrementos", "Soporte en Vivo 24/7"],
    ...
    bodyContent: {
      ...
      image: {
        ...
        caption: "Conocemos cada terminal, cada patrón de tráfico y cada solución ante el mal clima en todo Chicagoland.",
      },
      content: [
    ...
    extraContent: [
      {
        ...
        image: {
          ...
          caption: "Terminal 5 de O'Hare — las llegadas internacionales pueden tardar 90 minutos en aduana. Viaro ya está rastreando tu aterrizaje.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://www.choosechicago.com/">The Loop</A>,{" "}
            <A href="https://www.themagnificentmile.com/">Magnificent Mile</A>,{" "}
            <A href="https://www.mccormickplace.com/">McCormick Place</A>, River North, Evanston y los suburbios del oeste.
          </>,
        ],
      },
      {
        ...
        image: {
          ...
          caption: "Midway — más cerca del centro que O'Hare, seguridad más rápida. Viaro te recibe en el carril de vehículos comerciales.",
        },
        content: [
      ...
      },
      {
        ...
        image: {
          ...
          caption: "FBO de DuPage — la principal puerta de aviación privada de Chicagoland. Tiempo total en tierra: segundos, no minutos.",
        },
        content: [
          ...
          <>
            Consejo interno: Viaro coordina directamente con las operaciones FBO, incluyendo{" "}
            <A href="https://www.signatureflight.com/">Signature Flight Support</A>{" "}
            y{" "}
            <A href="https://www.atlanticaviation.com/">Atlantic Aviation</A>.{" "}
            Donde la seguridad lo permite, te recibimos al pie de la escalerilla. Bajas del avión y entras al asiento trasero—tiempo total en tierra medido en segundos, no minutos.
          </>,
    ...
    whereSection: {
      ...
      image: {
        ...
        caption: "Desde la Magnificent Mile hasta los campus corporativos, Viaro mueve a los viajeros más exigentes de Chicago.",
      },
      content: [
        <>
          Hoteles de lujo:{" "}
        ...
        <>
          Distritos de negocios: The Loop, River North, West Loop, Fulton Market, Merchandise Mart, Willis Tower,{" "}
          <A href="https://www.boeing.com/">Sede Global de Boeing</A>, y campus suburbanos en Schaumburg, Oak Brook y Naperville.
        </>,
        <>
          Convenciones y eventos:{" "}
          <A href="https://www.mccormickplace.com/">McCormick Place</A>{" "}
          (el centro de convenciones más grande de América del Norte), Navy Pier,{" "}
          <A href="https://www.unitedcenter.com/">United Center</A>, Soldier Field, Wrigley Field.
        </>,
        <>
          Compras y cultura:{" "}
          <A href="https://www.themagnificentmile.com/">Magnificent Mile</A>, Oak Street,{" "}
          <A href="https://www.artic.edu/">Instituto de Arte de Chicago</A>, Millennium Park, distrito de teatros de Chicago.
        </>,
        <>
          Universidades y salud:{" "}
          <A href="https://www.northwestern.edu/">Northwestern University</A>, Universidad de Chicago, Rush Medical Center, Northwestern Memorial Hospital.
        </>,
        <>Consulta nuestros{" "}
          <A href={`/es/black-car-service/corporate-transportation`}>servicios completos de transporte corporativo</A>{" "}
          y{" "}
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    hero: {
      image: {
        ...
        caption: "Desde el SFO hasta el Valle de Napa, de Silicon Valley a la ciudad—Viaro ofrece transporte ejecutivo impecable en toda el Área de la Bahía.",
      },
      ...
      cta: { book: "Reserva Tu Auto Negro en el Área de la Bahía", phone: "(206) 672-8281" },
    },

    trustBarTitle: "La confianza de los líderes de Silicon Valley",
    trustBar: ["60,000+ Viajes", "99.8% a Tiempo", "3 Aeropuertos", "Soporte en Vivo 24/7"],
    ...
    bodyContent: {
      ...
      image: {
        ...
        caption: "Conocemos cada terminal, cada empalme de autopista y cada alternativa al tráfico de hora pico en todo el Área de la Bahía.",
      },
      content: [
    ...
    extraContent: [
      {
        ...
        image: {
          ...
          caption: "Terminal Internacional del SFO — Viaro rastrea tu vuelo a través de los retrasos por niebla y te recibe en la zona de recogida del nivel superior.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://www.sftravel.com/">Centro de San Francisco</A>, Silicon Valley (Palo Alto, Mountain View, Menlo Park),{" "}
            <A href="https://www.visitnapavalley.com/">Valle de Napa</A> y campus corporativos en la Península.
          </>,
        ],
      },
      {
        ...
        content: [
          ...
          <>
            ...
            <A href="https://www.apple.com/">Apple Park</A>,{" "}
            <A href="https://about.google/">Google</A>,{" "}
            <A href="https://about.meta.com/">Meta</A>, Universidad de Stanford, Santa Cruz y Monterey.
          </>,
        ],
      },
      {
        ...
        image: {
          ...
          caption: "Aeropuerto de Oakland — sin niebla, seguridad más rápida, y Viaro sabe cuándo tomar el Puente San Mateo en lugar del Puente de la Bahía.",
        },
        content: [
          ...
          <>
            ...
            <A href="https://www.berkeley.edu/">UC Berkeley</A>, centro de Oakland, Walnut Creek, parques tech de Pleasanton/Dublin y conexiones a San Francisco vía Puente de la Bahía.
          </>,
        ],
        cta: "Reserva Tu Traslado al Aeropuerto →",
      },
    ...
    whereSection: {
      ...
      image: {
        ...
        caption: "Desde la Torre Salesforce hasta los viñedos de Sonoma, Viaro mueve a los viajeros más exigentes del Área de la Bahía.",
      },
      content: [
        <>
          País del vino:{" "}
          <A href="https://www.visitnapavalley.com/">Valle de Napa</A>,{" "}
          <A href="https://www.sonomacounty.com/">Sonoma</A>, Healdsburg, Yountville, St. Helena. Nuestro servicio de chofer por hora es perfecto para tours de vino de día completo.
        </>,
        <>
          Hoteles de lujo:{" "}
          <A href="https://www.fairmont.com/san-francisco/">Fairmont San Francisco</A>,{" "}
        ...
        <>
          Campus tech: Apple Park (Cupertino), Googleplex (Mountain View), Sede de Meta (Menlo Park),{" "}
          <A href="https://www.salesforce.com/">Torre Salesforce</A>{" "}
          (SF), Netflix (Los Gatos), Adobe, NVIDIA, LinkedIn y oficinas de capital de riesgo en Sand Hill Road.
        </>,
        <>
          Convenciones y eventos:{" "}
          <A href="https://www.moscone.com/">Centro Moscone</A>{" "}
          (Dreamforce, Apple WWDC, Google I/O),{" "}
          <A href="https://www.chasecenter.com/">Chase Center</A>, Oracle Park, Levi's Stadium.
        </>,
        <>
          Universidades:{" "}
          <A href="https://www.stanford.edu/">Universidad de Stanford</A>, UC Berkeley, UCSF, Universidad de Santa Clara.
        </>,
        <>Consulta nuestros{" "}
          <A href={`/es/black-car-service/corporate-transportation`}>servicios completos de transporte corporativo</A>{" "}
